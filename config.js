// config.js
// This serves as the initial configuration and data structure
    ...
    experience: [
        {
            ...
            date: "2021 - Present",
            details: "Led a team of 5 developers to rebuild the core legacy system. Improved load times by 40%. Implemented CI/CD pipelines."
        },
        {
